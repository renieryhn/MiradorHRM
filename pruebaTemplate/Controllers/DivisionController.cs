    ...
    public class DivisionController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdDivision,NombreDivision,Activo,FechaCreacion,FechaModificacion,CreadoPor,ModificadoPor")] Division division)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    if (ex.InnerException != null && ex.InnerException.Message.Contains("IX_Division"))
                    {
                        TempData["error"] = "Error: El nombre de la división ya está registrado. Por favor, ingrese un nombre diferente.";
                    }
                    else
                    {

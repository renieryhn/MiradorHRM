...
(OrgChart._defaultConfig = function (t) {
                            ...
                            if ((OrgChart.events.publish("render", [a, n]), (o = n.content), (t = n.res), (o += a.ui.lonely(a.config)), e !== OrgChart.action.exporting)) {
                                ...
                                if (m[0].length > 0) {
                                    ...
                                    OrgChart.animate(m[0], m[1], m[2], a.config.anim.duration, a.config.anim.func, function () {
                                        u || (i && i(), OrgChart.events.publish("redraw", [a]), a._showAfterAnimation(), (u = !0));
                                    });
                                }
                                e === OrgChart.action.centerNode
                                    ? OrgChart.animate(
                                        ...
                                        a.config.anim.func,
                                        function () {
                                            a.ripple(r.options.rippleId), u || (i && i(), OrgChart.events.publish("redraw", [a]), a._showAfterAnimation(), (u = !0));
                                        },
                                        function () {
                                    ...
                                    : !s ||
                                        ...
                                        ? 0 == m[0].length && (u || (i && i(), OrgChart.events.publish("redraw", [a]), (u = !0)))
                                        : OrgChart.animate(a.getSvg(), { viewbox: s }, { viewbox: a.response.viewBox }, 2 * a.config.anim.duration, a.config.anim.func, function () {
                                            a.xScrollUI.setPosition(), a.yScrollUI.setPosition(), u || (i && i(), OrgChart.events.publish("redraw", [a]), (u = !0));
                                        }),
                                ...
                                var C = t.boundary,
                                    O = C.maxX - C.minX,
                                    b = C.maxY - C.minY,
                                    v = a.ui.svg(O, b, [C.minX, C.minY, O, b], a.config, o, l);
                                i(v);
                            }
                        }
                    },
                ...
                for (var d = 0; d < t.length; d++)
                    for (var g in r[d]) {
                        ...
                        switch (g.toLowerCase()) {
                            ...
                            case "transform":
                                if (r[d][g]) {
                                    (C = e[d][g]), (O = r[d][g]), (b = [0, 0, 0, 0, 0, 0]);
                                    for (var v in C) b[v] = a((h * s - s) / i) * (O[v] - C[v]) + C[v];
                                    t[d].hasAttribute("transform") ? t[d].setAttribute("transform", "matrix(" + b.toString() + ")") : (t[d].style.transform = "matrix(" + b.toString() + ")");
                                }
                                break;
                            case "viewbox":
                                if (r[d][g]) {
                                    (C = e[d][g]), (O = r[d][g]), (b = [0, 0, 0, 0]);
                                    for (var v in C) b[v] = a((h * s - s) / i) * (O[v] - C[v]) + C[v];
    ...
    (OrgChart.editUI.prototype.content = function (t, e, r, i, a) {
        var n,
            ...
            u = this.obj._get(t),
            m = OrgChart.t(f.templateName, f.min, this.obj.getScale()),
            C = u[g],
            O = u[p];
        ...
        OrgChart.isNEU(C) && (C = ""), (O = OrgChart.isNEU(O) ? OrgChart.icon.user(150, 150, "#8C8C8C", 0, 0) : `<img style="width: 100%;height:100%;border-radius: 50%;" src="${O}"></img>`);
        var w = !e,
            k = e ? "display:none;" : "",
            S = e || !s ? "display:none;" : "",
            A = m.editFormHeaderColor ? `style="background-color:${m.editFormHeaderColor};"` : "",
            I = document.createElement("form");
        if (
            (I.setAttribute("data-boc-edit-form", ""),
                I.classList.add("boc-edit-form"),
                I.classList.add(this.obj.config.mode),
                I.classList.add(f.templateName),
                I.classList.add(OrgChart.ui._defsIds[f.templateName]),
                Array.isArray(f.tags) && f.tags.length)
        )
            for (b = 0; b < f.tags.length; b++) I.classList.add(f.tags[b]);
        (I.style.display = "flex"), (I.style.opacity = r ? 1 : 0), (I.style.right = r ? 0 : "-20px"), i && (I.style.width = i);
        var N = [],
            L = a ? "" : OrgChart.EDITFORM_CLOSE_BTN;
        return (
            (I.innerHTML = `<div>\n                        <div class="boc-edit-form-header" ${A}>\n                            ${L}\n                            <h1 class="boc-edit-form-title">${OrgChart._escapeGreaterLessSign(
                C
            )}</h1>\n                            <div id="boc-avatar" class="boc-edit-form-avatar">${O}</div>                        \n                        </div>\n                        <div data-boc-edit-from-btns class="boc-edit-form-instruments">\n                        ${(function () {
                if (a) return "";
                var t = "";
                for (var r in d) {
                    var i = d[r];
                    OrgChart.isNEU(i) || (w && i.hideIfEditMode) || (e && i.hideIfDetailsMode) || (o && "Edit" == i.text) || (t += `<div data-edit-from-btn='${r}' class="boc-img-button" ${A} title="${i.text}">${i.icon}</div>`);
                }
                return t;
            ...
            { element: I, focusId: n, title: C, shareText: N.join("\n") }
        );
    }),
    ...
    (OrgChart.circleMenuUI.prototype._show = function (t, e) {
        ...
        if (!OrgChart.isNEU(a.nodeCircleMenuButton)) {
            ...
            if (OrgChart.isNEU(p) || p.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id) != t) {
                ...
                for (var m = 0, C = Object.keys(f.menu).length, O = 2 * a.nodeCircleMenuButton.radius + 4, b = 2 * Math.PI * O, v = b / C - (2 * a.nodeCircleMenuButton.radius + 2); v < 0;)
                    (O += 8), (v = (b = 2 * Math.PI * O) / C - (2 * a.nodeCircleMenuButton.radius + 2));
                for (var x in ((p = document.createElementNS("http://www.w3.org/2000/svg", "g")).setAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id, t),
                    ...
                    A.setAttribute("cx", 0),
                        A.setAttribute("cy", 0),
                        A.setAttribute("r", a.nodeCircleMenuButton.radius),
                        A.setAttribute("fill", _),
                        A.setAttribute("stroke-width", "1"),
                        A.setAttribute("stroke", a.nodeCircleMenuButton.stroke),
                        k.appendChild(A),
                        k.appendChild(S),
                        (k.innerHTML += y),
                        p.appendChild(k);
                    ...
                    if ((I.setAttribute("pointer-events", "none"), I)) {
                        var N = parseInt(I.getAttribute("width")),
                            L = parseInt(I.getAttribute("height"));
                        I.setAttribute("x", -N / 2), I.setAttribute("y", -L / 2);
                    }
                    var E = (m * Math.PI) / (C / 2);
                    m++;
                    var M = Math.cos(E) * O,
                    ...
                    this._buttonsInterval.push(
                        OrgChart.animate(k, { transform: [1, 0, 0, 1, 0, 0] }, { transform: [1, 0, 0, 1, M, P] }, 250, OrgChart.anim.outBack, function (t) {
                            ...
                            t[0].addEventListener("mouseenter", function (t) {
                                OrgChart.events.publish("mouseenter", [r, { from: i, menuItem: f.menu[e], menuItemName: e, event: t }]);
                            }),
                                t[0].addEventListener("mouseout", function (t) {
                                    OrgChart.events.publish("mouseout", [r, { from: i, menuItem: f.menu[e], menuItemName: e, event: t }]);
                                });
                        })
                    );
                }
    ...
    (OrgChart.prototype._export = function (t, e) {
        var r = this,
            i = { id: t.nodeId, expandChildren: t.expandChildren };
    ...
    (OrgChart.prototype._pagesA100 = function (t, e, r) {
        ...
        for (var g = c.w * (100 / r), p = c.h * (100 / r), f = o, u = l, m = []; f < s + o;) {
            for (; u < h + l;) {
                var C = [f, u, g, p];
                (C = C.join()), m.push({ vb: C, innerSize: c, size: d }), (u += p);
            }
            (f += g), (u = l);
        }
        return m;
    ...
    (OrgChart.prototype._nodeCircleNodeMenuItemMouseDownHandler = function (t, e, r) {
        ...
        if (n.draggable) {
            ...
            f.setAttribute("transform", "matrix(1,0,0,1," + (m + O.x) + "," + (C + O.y) + ")"), (f.style.opacity = 0.7);
            var b = function (t, e) {
                if (null != t) {
                ...
                v = function (e) {
                    if (p) {
                        ...
                        var l = OrgChart._getOffsetXY(o.element, e),
                            s = { left: o.width() - (l.x + o.config.padding) < 0, right: l.x - o.config.padding < 0, down: o.height() - (l.y + o.config.padding) < 0, up: l.y - o.config.padding < 0 };
                        if (s.left || s.right || s.up || s.down) {
                            ...
                            for (
                                o.stopMove(),
                                g.classList && (g.classList.add("boc-cursor-grab"), g.classList.remove("boc-cursor-move"), g.classList.remove("boc-cursor-nodrop"), g.classList.remove("boc-cursor-copy")),
                                b(c, d),
                                c = null,
                                d = null;
                                null != i && i != g;
                                ...
                                if (i.hasAttribute && i.hasAttribute(OrgChart.attr.node_id)) {
                                    var A = i.getAttribute(OrgChart.attr.node_id);
                                    (c = A), (d = i);
                                    break;
                                }
                                i = i.parentNode;
                            ...
                            if (null != c) {
                                ...
                                for (var I = o.getNode(c), N = OrgChart.getStParentNodes(I), L = 0; L < N.length; L++) {
                            ...
                            var M = (r.x - p.x) / h,
                                P = (r.y - p.y) / h;
                            if (((u[4] = m + M), (u[5] = C + P), !t._dragEventFired && (Math.abs(r.x - p.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - p.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)))
                                !1 === OrgChart.events.publish("drag", [o.nodeCircleMenuUI, { from: A, menuItem: n, menuItemName: a }]) && x(), (t._dragEventFired = !0);
                            f.setAttribute("transform", "matrix(" + u.toString() + ")");
                        }
                    }
                },
                x = function (e) {
                    if (
                        ...
                        return g.removeChild(f), (o._gragStartedId = null), void (t._dragEventFired && OrgChart.events.publish("drop", [o.nodeCircleMenuUI, { from: s.id, menuItemName: a, menuItem: n }]));
                    var i = o.getNode(c);
                    OrgChart.events.publish("drop", [o.nodeCircleMenuUI, { from: s.id, to: i.id, menuItem: n, menuItemName: a }]), b(c, d), g.removeChild(f), (o._gragStartedId = null);
                };
    ...
    (OrgChart.prototype._nodeMouseDownHandler = function (t, e, r) {
        if (this.config.enableDragDrop) {
            ...
            var s = this,
                ...
                f = s.getScale(),
                u = t.cloneNode(!0);
            h.insertBefore(u, h.firstChild), (u.style.opacity = 0.7);
            var m = function (t, e) {
                if (null != t) {
                    e.classList.remove("boc-drag-over");
                ...
                C = function (e) {
                    if (c) {
                        ...
                        var a = OrgChart._getOffsetXY(s.element, e),
                            C = { left: s.width() - (a.x + s.config.padding) < 0, right: a.x - s.config.padding < 0, down: s.height() - (a.y + s.config.padding) < 0, up: a.y - s.config.padding < 0 };
                        if (C.left || C.right || C.up || C.down) {
                            ...
                            if (null != o) {
                                ...
                                for (var S = s.getNode(o), A = OrgChart.getStParentNodes(S), I = 0; I < A.length; I++) {
                                    var N = s.getNodeElement(A[I].id);
                            ...
                            var L = (r.x - c.x) / f,
                                E = (r.y - c.y) / f;
                            if (((d[4] = g + L), (d[5] = p + E), !t._dragEventFired && (Math.abs(r.x - c.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - c.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)))
                ...
                O = function (e) {
                    if (
                        ...
                        return h.removeChild(u), (s._gragStartedId = null), void (t._dragEventFired && OrgChart.events.publish("drop", [s, n.id]));
                    var i = s.getNode(o);
                    if (!1 === OrgChart.events.publish("drop", [s, n.id, i.id])) return m(o, l), h.removeChild(u), void (s._gragStartedId = null);
                    if (s.canUpdateLink(n.id, o)) {
                        var a = s.get(n.id);
                        (a.pid = o), (a.stpid = null), s.updateNode(a, null, !0);
                    } else h.removeChild(u), m(o, l);
    ...
    (OrgChart.prototype._mouseDownHandler = function (t, e, r) {
        ...
        if ("pan" == s.type) {
            ...
            (h.style.display = "inherit"),
                ...
                OrgChart.animate(h, { transform: [0, 0, 0, 0, d, g], opacity: 0 }, { transform: [1 / n, 0, 0, 1 / n, d, g], opacity: 1 }, 300, OrgChart.anim.outBack);
        }
        var p = function (t) {
    ...
    (OrgChart.searchUI.prototype.init = function (t) {
        ...
        (l.innerHTML += s.html), (this.xBtn = l.querySelector("[boc-input-btn]")), (this.xBtn.style.display = "none"), (this.searchTableWrapper = document.createElement("div")), l.appendChild(this.searchTableWrapper);
    ...
    (OrgChart.manager.prototype.read = function (t, e, r, i, a, n, o, l) {
        ...
        OrgChart.state._get(this.config.state, e, r, function (h) {
            ...
            if (t) {
                ...
                a != OrgChart.action.exporting && ((s.maxX = c), (s.maxY = d), (s.minX = g), (s.minY = p), (s.roots = u), (s.nodes = m), (s.visibleNodeIds = C.visibleNodeIds)),
                ...
                (s.oldNodes = m || null),
                    s._read(function (t) {
                        (c = t.maxX), (d = t.maxY), (g = t.minX), (p = t.minY), (f = t.bordersByRootIdAndLevel), (u = t.roots), (m = t.nodes);
                        ...
                        (i.notif = t.limit),
                            ...
                            ((s.maxX = c), (s.maxY = d), (s.minX = g), (s.minY = p), (s.roots = u), (s.nodes = m), (s.visibleNodeIds = i.visibleNodeIds), (s.bordersByRootIdAndLevel = f), (s.rootList = t.rootList)),
                            o(i);
                    }, l);
        });
    }),
    ...
    (OrgChart.manager._initNode = function (t, e, r, i, a, n, o) {
        ...
        for (var p = 0; p < t.childrenIds.length; p++) {
            ...
            if ((OrgChart.manager._setCollpasedProperty(f, g, c, a, h, i, d), !f.collapsed)) {
                ...
                (-1 != f.tags.indexOf("left-partner") || -1 != f.tags.indexOf("right-partner") || -1 != f.tags.indexOf("partner") || f.parentPartner) && -1 == n.indexOf(t.id) && n.push(t.id), t.children.push(f);
            }
        }
        if (
            (t.min || h != OrgChart.action.minimize || ((c.all || c.id == t.id) && (t.min = !0)),
                !0 === t.min && h == OrgChart.action.maximize && (c.all || c.id == t.id) && (t.min = !1),
    ...
    (OrgChart.manager._iterate = function (t, e, r, i, a, n, o, l, s, h, c, d) {
        ...
        if (
            ...
            if (e.parent && e.parent.children.length && e.parent.children[e.parent.children.length - 1] == e) {
                for (var p = [], f = 0, u = 0, m = 0; m < e.parent.children.length; m++) {
                    -1 == (C = e.parent.children[m]).tags.indexOf("partner") && -1 == C.tags.indexOf("left-partner") && -1 == C.tags.indexOf("right-partner") && -1 == C.tags.indexOf("assistant") && 0 == C.children.length
                        ...
                        : -1 != C.tags.indexOf("assistant")
                            ? f++
                            : (-1 == C.tags.indexOf("partner") && -1 == C.tags.indexOf("left-partner") && -1 == C.tags.indexOf("right-partner")) || u++;
                }
                ((OrgChart.MIXED_LAYOUT_ALL_NODES && p.length > 1 && p.length == e.parent.children.length - f - u) || (!OrgChart.MIXED_LAYOUT_ALL_NODES && p.length > 1)) && (l[e.pid] = p);
            }
        } else if (!e.isAssistant && 0 == e.childrenIds.length && e.parent && !l[e.pid]) {
            for (p = [], f = 0, u = 0, m = 0; m < e.parent.children.length; m++) {
                var C;
            ...
            ((OrgChart.MIXED_LAYOUT_ALL_NODES && p.length > 1 && p.length == e.parent.childrenIds.length - f - u) || (!OrgChart.MIXED_LAYOUT_ALL_NODES && p.length > 1)) && (l[e.pid] = p);
        }
    ...
    (OrgChart.manager.__createNodes = function (t, e, r, i, a, n, o, l) {
        ...
        for (c = 0; c < h.length; c++) {
            ...
            } else b ? (C && ((u.collapsed = C.collapsed), (u.min = C.min)), b.childrenIds.push(u.id)) : (C && ((u.collapsed = C.collapsed), (u.min = C.min)), e.push(u), o.push(u.id));
    ...
    (OrgChart.manager._createNodes = function (t) {
        ...
        if ((OrgChart.manager.__createNodes(l, s, e, i, a, n, h, t), null != e.roots)) {
            ...
            for (var c = 0; c < e.roots.length; c++) {
                ...
                if (d && i == OrgChart.action.centerNode) {
                    ...
                    for (var p = l[a.id]; (null != p.pid || null != p.stpid) && p != d;) p = null == p.pid && null != p.stpid ? l[p.stpid] : l[p.pid];
                    g == p && (d = g);
                }
                if (d) {
                    ...
                    if (!f) {
                        if (!OrgChart.isNEU(d.pid)) (j = (b = l[d.pid]).childrenIds.indexOf(d.id)) > -1 && b.childrenIds.splice(j, 1);
                        s.push(d);
                    }
                }
            }
        ...
        if (i == OrgChart.action.init && e.expand && e.expand.nodes && null == o)
            ...
            for (c = 0; c < O.length; c++) for (var b = l[(C = l[O[c]]).pid]; b;) m.push(b.id), null == b.pid && null != b.stpid ? ((b = l[b.stpid]).min = !1) : (b = l[b.pid]);
        ...
        var _ = [],
            ...
            S = {},
            A = [];
        for (c = 0; c < s.length; c++) OrgChart.manager._iterate(s[c], s[c], l, 0, _, w, k, S, "", m, A, t);
        ...
        for (c = 0; c < A.length; c++) {
            ...
            for (x = 0; x < N.length; x++) {
                E[(z = l[N[x]]).id] ? C.children.push(z) : C.children.splice(0, 0, z);
                for (var R = 0; R < z.childrenIds.length; R++) H.push(z.childrenIds[R]);
            }
            var F = [];
            for (x = 0; x < L.length; x++) {
                E[(z = l[L[x]]).id] ? C.children.push(z) : C.children.splice(0, 0, z);
                for (R = 0; R < z.childrenIds.length; R++) F.push(z.childrenIds[R]);
            }
            for (x = 0; x < F.length; x++) {
                (z = l[F[x]]).collapsed || ((z.parentPartner = z.parent), (z.parent = C), (z.isChildOfPartner = !0), C.children.push(z));
            }
            for (x = L.length - 1; x >= 0; x--) if (E[L[x]]) for (u = 0; u < E[L[x]].length; u++) C.children.push(l[E[L[x]][u]]), P++, -1 == U.indexOf(L[x]) && U.push(L[x]);
            for (x = 0; x < I.length; x++) {
                var z = l[I[x]];
                C.children.push(z);
            }
            for (x = 0; x < N.length; x++) if (E[N[x]]) for (u = 0; u < E[N[x]].length; u++) C.children.push(l[E[N[x]][u]]), T++, -1 == B.indexOf(N[x]) && B.push(N[x]);
            for (x = 0; x < H.length; x++) {
                (z = l[H[x]]).collapsed || ((z.parentPartner = z.parent), (z.parent = C), (z.isChildOfPartner = !0), C.children.push(z));
            }
        ...
        for (c = 0; c < k.length; c++) {
            if ((at = r[(C = l[k[c]]).lcn ? C.lcn : "base"]).layout == OrgChart.normal || !S[C.pid])
                for (x = 0; x < C.subLevels; x++) {
                    var j,
                        D = new OrgChart.node(C.id + "_sub_level_index_" + x, C.pid, [], "subLevel");
                    if ((OrgChart.manager._initDinamicNode(D, C.lcn), (b = C.parent)))
                        (j = b.children.indexOf(C)) > -1 && (b.children.splice(j, 1), b.children.splice(j, 0, D)), D.children.push(C), (D.parent = b), (C.parent = D), (l[D.id] = D);
                }
        }
        for (var Y in w) {
            (b = l[Y]).hasAssistants = !0;
            D = new OrgChart.node(b.id + "_split_assitant_0", b.id, ["assistant"], "split");
            OrgChart.manager._initDinamicNode(D, b.lcn, !0), (l[D.id] = D);
            var X = [];
            for (x = b.children.length - 1; x >= 0; x--) {
                (z = b.children[x]).isAssistant
                    ? ((z.parent = null), b.children.splice(x, 1), X.splice(0, 0, z.id))
                    : z.isPartner ||
                    (z.parent && S[z.parent.id] && D && z.parent.id != D.id && (Object.defineProperty(S, D.id, Object.getOwnPropertyDescriptor(S, z.parent.id)), delete S[z.parent.id]),
                        (z.parent = D),
                        D.children.unshift(z),
                        b.children.splice(x, 1));
            }
            if (X.length % 2) {
                var q = l[X[X.length - 1]],
                    V = new OrgChart.node(q.id + "_mirror", b.pid, [], "mirror");
                OrgChart.manager._initDinamicNode(V, q.lcn, !0), (q._m = V.id), (V.isAssistant = !0), (V.w = q.w), (V.h = q.h), (l[V.id] = V), X.splice(X.length - 1, 0, V.id);
            }
            var $ = 1;
            for (x = X.length - 1; x >= 0; x--)
                if (x % 2 && x != X.length - 1) {
                    var W = new OrgChart.node(b.id + "_split_assitant_" + $, b.pid, [], "split");
                    OrgChart.manager._initDinamicNode(W, b.lcn, !0), (l[W.id] = W), X.splice(x, 0, W.id), $++;
                } else x % 2 && X.splice(x, 0, D.id);
        ...
        if (Q || et) {
            ...
            for (var Y in S) {
                ...
                var at;
                if ((at = r[b.lcn ? b.lcn : "base"]).layout == OrgChart.mixed || at.layout == OrgChart.tree || at.layout == OrgChart.treeRightOffset || at.layout == OrgChart.treeLeftOffset || et)
                    if (
                        ((rt.pnode = b), (rt.layout = at.layout), (rt.childrenIds = S[Y]), (rt.lastChildrenPidIds = S), OrgChart.events.publish("node-layout", [t, rt]), OrgChart.events.publish("layout", [rt]), rt.layout == OrgChart.mixed)
                    ) {
                        ...
                        D = new OrgChart.node(b.id + "_split_0", it.id, [], "split");
                        OrgChart.manager._initDinamicNode(D, b.lcn), (l[D.id] = D), (D.layout = OrgChart.tree);
                        var lt = [];
                        for (c = rt.childrenIds.length - 1; c >= 0; c--) {
                            for (z = l[rt.childrenIds[c]], x = 0; x < b.children.length; x++) b.children[x].id == z.id && b.children.splice(x, 1);
                            if (((z.parent = null), (z.layout = OrgChart.tree), rt.layout == OrgChart.treeRightOffset && lt.splice(0, 0, z.id), rt.layout == OrgChart.treeLeftOffset || rt.layout == OrgChart.treeRightOffset)) {
                                var st = new OrgChart.node(z.id + "_mirror", it.id, [], "mirror");
                                OrgChart.manager._initDinamicNode(st, z.lcn), (st.layout = OrgChart.tree), (l[st.id] = st), lt.splice(0, 0, st.id);
                            }
                            rt.layout != OrgChart.treeRightOffset && lt.splice(0, 0, z.id);
                        }
                        for ($ = 1, x = lt.length - 1; x >= 0; x--)
                            if (x % 2 && x != lt.length - 1) {
                                W = new OrgChart.node(b.id + "_split_" + $, it.id, [], "split");
                                OrgChart.manager._initDinamicNode(W, b.lcn), (W.layout = OrgChart.tree), (l[W.id] = W), lt.splice(x, 0, W.id), $++;
                            } else x % 2 && lt.splice(x, 0, D.id);
                        for (x = 0; x < lt.length; x += 3) {
                            G = null;
                            0 == x && (G = b);
                            (K = l[lt[x]]), (J = l[lt[x + 1]]), (Z = l[lt[x + 2]]);
                            0 != x && (G = l[lt[x - 3]]),
                                0 == x || J || (G = l[lt[x - 2]]),
                                (K.parent = G),
                                G.children.push(K),
                                J && (0 != x && (G = l[lt[x - 2]]), (J.parent = G), G.children.push(J)),
                                Z && (0 != x && (G = l[lt[x - 1]]), (Z.parent = G), G.children.push(Z));
                        }
                    }
            }
        }
        if (OrgChart.VERTICAL_CHILDREN_ASSISTANT) for (c = 0; c < s.length; c++) OrgChart.manager._verticalAssistantIterate(s[c], l);
    ...
    (OrgChart.manager._getResponse = function (t, e, r, i, a, n, o, l, s, h, c, d, g, p, f) {
        ...
        if (c == OrgChart.action.insert || c == OrgChart.action.expand || c == OrgChart.action.collapse || c == OrgChart.action.update || c == OrgChart.action.centerNode || c == OrgChart.action.maximize) {
            var A = null;
            if (c == OrgChart.action.insert && d && null != d.insertedNodeId && null != d.insertedNodeId) A = g[d.insertedNodeId];
            else if (c == OrgChart.action.update && d && null != d.visId && null != d.visId) A = g[d.visId];
                ...
                if (c == OrgChart.action.centerNode || c == OrgChart.action.maximize) {
                    switch (i.orientation) {
                        ...
                        case OrgChart.orientation.bottom:
                        case OrgChart.orientation.bottom_left:
                            d.options.vertical || (A = g[d.id]);
                            break;
                        case OrgChart.orientation.right:
                        case OrgChart.orientation.right_top:
                        case OrgChart.orientation.left:
                        case OrgChart.orientation.left_top:
                            d.options.horizontal || (A = g[d.id]);
                    }
                    A && (A = OrgChart.manager._getMostDeepChild(A, g));
                }
            } else (A = g[d.id]), (A = OrgChart.manager._getMostDeepChild(A, g));
            if (!OrgChart.FIXED_POSITION_ON_CLICK && A)
                switch (i.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                        var I = A.y + A.h - s[3] + i.padding;
                        s[1] < I && (s[1] = I);
                        break;
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                    ...
                    case OrgChart.orientation.left:
                    case OrgChart.orientation.left_top:
                        I = A.x + A.w - s[2] + i.padding;
                        s[0] < I && (s[0] = I);
                }
        }
        for (var N = 0; N < h.length; N++) OrgChart.manager._iterate2(h[N], g, i, s, c, d, m, p, r, O);
        return { animations: O, boundary: C, viewBox: s, visibleNodeIds: m, nodes: g, allFields: OrgChart.manager.getAllFields(i) };
    }),
    (OrgChart.manager._iterate2 = function (t, e, r, i, a, n, o, l, s, h) {
        if (OrgChart.manager._isVisible(t, r, i, a)) {
            ...
            if ((a == OrgChart.action.expand || a == OrgChart.action.collapse || a == OrgChart.action.maximize) && l && l[t.id] && "expandCollapseToLevel" == n.method) {
                ...
                if ((null != (f = l[t.id]).x && null != f.y && (c = { x: f.x, y: f.y }), (p = e[n.id]) && p == t)) (d = t.parent) && d.id == n.id && (c = { x: p.x + p.w / 2 - t.w / 2, y: p.y + p.h / 2 - t.h / 2 });
    ...
    (OrgChart.manager._setMinMaxXYAdjustifyIterate = function (t, e, r, i, a, n, o) {
        ...
        t.isPartner ? (t.sl = i - 1) : (t.sl = i), null == a[e.id] && (a[e.id] = {}), null == a[e.id][t.sl] && (a[e.id][t.sl] = { minX: null, minY: null, maxX: null, maxY: null }), t.layout || OrgChart._setMinMaxXY(t, a[e.id][t.sl]), i++;
    ...
    (OrgChart.templates.ana = {
        ...
        plus:
            '<circle cx="15" cy="15" r="15" class="boc-fill" stroke="#aeaeae" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#aeaeae"></line><line x1="15" y1="4" x2="15" y2="26" stroke-width="1" stroke="#aeaeae"></line>',
    ...
    (OrgChart.ui = {
        ...
        node: function (t, e, r, i, a, n, o, l, s, h) {
            ...
            for (var p in o) {
                ...
                if (((g.value = f), (g.element = c[p]), (g.name = u), !1 !== OrgChart.events.publish("field", [h, g]) && null != g.value && null != g.value && null != g.element)) {
                    m || "string" != typeof g.value || (g.value = OrgChart.wrapText(g.value, g.element));
                    var C = g.element.replace("{val}", g.value);
                    d += C = C.replaceAll("{ew}", t.w - (t.padding ? t.padding[1] : 0))
                        .replaceAll("{cw}", t.w / 2)
            ...
            var O = OrgChart._getPosition(r, t, a, n),
                b = "node";
            Array.isArray(t.tags) && t.tags.length && (b += " " + t.tags.join(" ")), t.layout && (b += " tree-layout");
            var v = "";
            t.lcn && (v = 'lcn="' + t.lcn + '"');
            var x = OrgChart.nodeOpenTag.replace("{lcn}", v).replace("{id}", t.id).replace("{class}", b).replace("{sl}", t.sl).replace("{level}", t.level).replace("{x}", O.x).replace("{y}", O.y),
                y = OrgChart._getOpacity(r, t);
            return (d = (x = x.replace("{opacity}", y)) + (d += OrgChart.ui.nodeBtns(i, t, l, c, h)) + OrgChart.grCloseTag);
        },
            ...
            if (i !== OrgChart.action.exporting && !e.isSplit) {
                ...
                if (e.childrenIds.length > 0) {
                    ...
                    if (-1 != n.indexOf("{collapsed-children-total-count}")) {
                        var p = OrgChart.collapsedChildrenTotalCount(t, e);
                        n = n.replace("{collapsed-children-total-count}", p);
                    }
                    ...
                    if (-1 != n.indexOf("{children-total-count}")) {
                        var u = OrgChart.childrenTotalCount(t, e);
                        n = n.replace("{children-total-count}", u);
                    }
                }
        ...
        link: function (t, e, r, i, a, n) {
            ...
            var d = 0,
                ...
                f = void 0;
            if (t.hasPartners) {
                f = { ids: [], indexes: {}, ppnodes: {}, lastLeft: null, firstRight: null, maxSidePartnersWithChildren: 0, rightIds: [], leftIds: [], partnerChildrenSplitSeparation: e.config.partnerChildrenSplitSeparation };
                for (var u = 0; u < t.children.length; u++) {
                    (m = t.children[u]).parentPartner
                        ? ((f.ppnodes[m.id] = m.parentPartner),
                            f.ids.push(m.id),
                            1 == m.parentPartner.isPartner
                                ? (-1 == f.rightIds.indexOf(m.parentPartner.id) && f.rightIds.push(m.parentPartner.id), (f.indexes[m.id] = f.rightIds.indexOf(m.parentPartner.id)), f.firstRight || (f.firstRight = m))
                                : 2 == m.parentPartner.isPartner && (-1 == f.leftIds.indexOf(m.parentPartner.id) && f.leftIds.push(m.parentPartner.id), (f.indexes[m.id] = f.leftIds.indexOf(m.parentPartner.id)), (f.lastLeft = m)))
                        : m.isPartner || ((f.lastLeft = m), f.firstRight || (f.firstRight = m));
                }
            ...
            for (u = 0; u < t.children.length; u++) {
                var m = t.children[u],
                    ...
                    b = (s = OrgChart.t(m.templateName, m.min, r)).link;
                if (m.isChildOfPartner)
                    switch (l.orientation) {
                        case OrgChart.orientation.top:
                        case OrgChart.orientation.top_left:
                            var v = 1 == m.layout ? void 0 : C.minY - (C.minY - p.maxY) / 2;
                            O = OrgChart.ui._linkTopToBottom(m.parentPartner, m, s, c, v);
                            break;
                        case OrgChart.orientation.bottom:
                        case OrgChart.orientation.bottom_left:
                            v = 1 == m.layout ? void 0 : C.maxY - (C.maxY - p.minY) / 2;
                            O = OrgChart.ui._linkBottomToTop(m.parentPartner, m, s, c, v);
                            break;
                        case OrgChart.orientation.right:
                        case OrgChart.orientation.right_top:
                            v = 1 == m.layout ? void 0 : C.maxX - (C.maxX - p.minX) / 2;
                            O = OrgChart.ui._linkRightToLeft(m.parentPartner, m, s, c, v);
                            break;
                        case OrgChart.orientation.left:
                        case OrgChart.orientation.left_top:
                            v = 1 == m.layout ? void 0 : C.minX - (C.minX - p.maxX) / 2;
                            O = OrgChart.ui._linkLeftToRight(m.parentPartner, m, s, c, v);
                    }
                else if (f && -1 != f.ids.indexOf(m.id))
                    switch (l.orientation) {
                        case OrgChart.orientation.top:
                        case OrgChart.orientation.top_left:
                            O = OrgChart.ui._linkPpTop(f, t, m, C, p, s);
                            break;
                        case OrgChart.orientation.bottom:
                        case OrgChart.orientation.bottom_left:
                            O = OrgChart.ui._linkPpBottom(f, t, m, C, p, s);
                            break;
                        case OrgChart.orientation.right:
                        case OrgChart.orientation.right_top:
                            O = OrgChart.ui._linkPpRight(f, t, m, C, p, s);
                            break;
                        case OrgChart.orientation.left:
                        case OrgChart.orientation.left_top:
                            O = OrgChart.ui._linkPpLeft(f, t, m, C, p, s);
                    }
                else {
                    var x = m.isAssistant && m.rightNeighbor && m.rightNeighbor.isAssistant && m.parent == m.rightNeighbor.parent,
                        y = m.isAssistant && m.leftNeighbor && m.leftNeighbor.isAssistant && m.parent == m.leftNeighbor.parent;
                    if ((x || 2 == m.layout) && m.rightNeighbor && m.rightNeighbor.isSplit)
                        switch (l.orientation) {
                            case OrgChart.orientation.top:
                            case OrgChart.orientation.top_left:
                            case OrgChart.orientation.bottom:
                            case OrgChart.orientation.bottom_left:
                                O = OrgChart.ui._linkRightToLeft(m.rightNeighbor, m, s, c);
                                break;
                            case OrgChart.orientation.right:
                            case OrgChart.orientation.right_top:
                            case OrgChart.orientation.left:
                            case OrgChart.orientation.left_top:
                                O = OrgChart.ui._linkBottomToTop(m.rightNeighbor, m, s, c);
                        }
                    else if ((y || 2 == m.layout) && m.leftNeighbor && m.leftNeighbor.isSplit)
                        switch (l.orientation) {
                            case OrgChart.orientation.top:
                            case OrgChart.orientation.top_left:
                            case OrgChart.orientation.bottom:
                            case OrgChart.orientation.bottom_left:
                                O = OrgChart.ui._linkLeftToRight(m.leftNeighbor, m, s, c);
                                break;
                            case OrgChart.orientation.right:
                            case OrgChart.orientation.right_top:
                            case OrgChart.orientation.left:
                            case OrgChart.orientation.left_top:
                                O = OrgChart.ui._linkTopToBottom(m.leftNeighbor, m, s, c);
                        }
                    else
                        switch (l.orientation) {
                            case OrgChart.orientation.top:
                            case OrgChart.orientation.top_left:
                                if (1 == m.isPartner) O = OrgChart.ui._linkLeftToRight(t, m, s, d);
                                else if (2 == m.isPartner) O = OrgChart.ui._linkRightToLeft(t, m, s, d);
                                else {
                                    v = 1 == m.layout ? void 0 : C.minY - (C.minY - p.maxY) / 2;
                                    O = OrgChart.ui._linkTopToBottom(t, m, s, c, v);
                                }
                                break;
                            case OrgChart.orientation.bottom:
                            case OrgChart.orientation.bottom_left:
                                if (1 == m.isPartner) O = OrgChart.ui._linkLeftToRight(t, m, s, d);
                                    ...
                                    v = 1 == m.layout ? void 0 : C.maxY - (C.maxY - p.minY) / 2;
                                    O = OrgChart.ui._linkBottomToTop(t, m, s, c, v);
                                }
                                break;
                            case OrgChart.orientation.right:
                            case OrgChart.orientation.right_top:
                                if (1 == m.isPartner) O = OrgChart.ui._linkTopToBottom(t, m, s, d);
                                else if (2 == m.isPartner) O = OrgChart.ui._linkBottomToTop(t, m, s, d);
                                else {
                                    v = 1 == m.layout ? void 0 : C.maxX - (C.maxX - p.minX) / 2;
                                    O = OrgChart.ui._linkRightToLeft(t, m, s, c, v);
                                }
                                break;
                            case OrgChart.orientation.left:
                            case OrgChart.orientation.left_top:
                                if (1 == m.isPartner) O = OrgChart.ui._linkTopToBottom(t, m, s, d);
                                    ...
                                    v = 1 == m.layout ? void 0 : C.minX - (C.minX - p.maxX) / 2;
                                    O = OrgChart.ui._linkLeftToRight(t, m, s, c, v);
                                }
                        }
                }
                if (-1 != b.indexOf("{rounded}"))
                    if ((O.xa == O.xb && O.xa == O.xc && O.xa == O.xd) || (O.ya == O.yb && O.ya == O.yc && O.ya == O.yd)) b = b.replace("{rounded}", "M" + O.xa + "," + O.ya + " L" + O.xd + "," + O.yd);
                    else if (Math.abs(O.xa - O.xd) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(O.xa - O.xc) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(O.xa - O.xb) <= OrgChart.LINK_ROUNDED_CORNERS)
                        b = b.replace("{rounded}", "M" + O.xa + "," + O.ya + " L" + O.xa + "," + O.yd);
                    else if (Math.abs(O.ya - O.yd) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(O.ya - O.yc) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(O.ya - O.yb) <= OrgChart.LINK_ROUNDED_CORNERS)
                    ...
                    b =
                        -1 != b.indexOf("{edge}")
                            ? b.replace("{edge}", "M" + O.xa + "," + O.ya + " " + O.xb + "," + O.yb + " " + O.xc + "," + O.yc + " L" + O.xd + "," + O.yd)
                            : -1 != b.indexOf("{curve}")
                                ? b.replace("{curve}", "M" + O.xa + "," + O.ya + " C" + O.xb + "," + O.yb + " " + O.xc + "," + O.yc + " " + O.xd + "," + O.yd)
                                : b.replaceAll("{xa}", O.xa).replaceAll("{ya}", O.ya).replaceAll("{xb}", O.xb).replaceAll("{yb}", O.yb).replaceAll("{xc}", O.xc).replaceAll("{yc}", O.yc).replaceAll("{xd}", O.xd).replaceAll("{yd}", O.yd);
                h.push(
                ...
                var k = { node: t, cnode: m, p: O, html: b, action: n };
                OrgChart.events.publish("render-link", [e, k]), h.push(k.html);
                var S = "";
                for (var A in e.config.linkBinding) {
                    var I = e.config.linkBinding[A],
                        N = e._get(m.id);
                    if (N) {
                        var L = N[I];
                        (k.value = L), (k.element = s[A]), (k.name = I), !1 !== OrgChart.events.publish("label", [e, k]) && (OrgChart.isNEU(k.value) || OrgChart.isNEU(k.element) || (S += k.element.replace("{val}", k.value)));
                    }
                }
                "" != S && ((S = OrgChart.linkFieldsOpenTag.replace("{x}", O.x).replace("{y}", O.y).replace("{rotate}", 0) + S + OrgChart.grCloseTag), h.push(S)), h.push(OrgChart.grCloseTag);
            }
            return h.join("");
        },
    ...
    (OrgChart.wrapText = function (t, e) {
        ...
        if (OrgChart._isHTML(t)) return OrgChart._escapeHtml(t);
        ...
        d || (d = "ellipsis");
        var f = d.split("-");
        if ((f.length > 1 && ((a = parseInt(d.split("-")[1])), f.length > 2 && "ellipsis" == f[2] && (n = !0)), !c)) return OrgChart._escapeHtml(t);
        if (((c = parseFloat(c)), l || (l = 0), s || (s = 0), l || (h = "start"), "ellipsis" == d)) {
            p.removeChild(p.firstChild), (p.textContent = t);
            for (var u = p.getComputedTextLength(), m = 2; u > c;) (p.textContent = t.substring(0, t.length - m)), (p.textContent += "..."), (u = p.getComputedTextLength()), m++;
        ...
        if (-1 != d.indexOf("multiline")) {
            ...
            for (var x = 1, y = 1; y < C.length; y++) {
                ...
                if (((b.firstChild.data += " " + C[y]), b.getComputedTextLength() > c)) {
    ...
    (OrgChart.pdfPrevUI._handler = function (t, e, r) {
        ...
        for (var s = l.querySelector("svg"), h = t.element.querySelector("#boc-ppdf-content"), c = 0; c < a.length; c++) {
            ...
            a[c].footer && (f = a[c].footer),
                ...
                a[c].html
                    ? g.write(OrgChart._exportHtml(a[c].html, e.styles, i, a[c].innerSize.w, a[c].innerSize.h, p, f, t.config.mode))
                    : (s.setAttribute("viewBox", a[c].vb), g.write(OrgChart._exportHtml(l.innerHTML, e.styles, i, a[c].innerSize.w, a[c].innerSize.h, p, f, t.config.mode)));
    ...
    (OrgChart._exportHtml = function (t, e, r, i, a, n, o, l) {
        ...
        return (
            n && (c += '<div id="boc-header" style="width:' + i + "px;color:#757575;position:absolute;left:" + r.margin[3] + 'px;top:0;">' + n + "</div>"),
            (c += t),
        ...
        for (var r, i, a, n, o, l = "", s = 0; s < this.config.clinks.length; s++) {
            ...
            if (c && -1 != e.res.visibleNodeIds.indexOf(c.id) && d && -1 != e.res.visibleNodeIds.indexOf(d.id)) {
                ...
                switch (this.config.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                        O <= b ? ((y = 1), (m.x = O + c.w / 10), (C.x = b - d.w / 10)) : ((y = -1), (m.x = O - c.w / 10), (C.x = b + d.w / 10)),
                            p == u ? ((y = 1), (m.y = p), (C.y = u)) : p > u ? ((m.y = p), (C.y = u + d.h)) : ((m.y = p + c.h), (C.y = u));
                        break;
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                        O <= b ? ((y = -1), (m.x = O + c.w / 10), (C.x = b + d.w / 10)) : ((y = 1), (m.x = O - c.w / 10), (C.x = b + d.w / 10)),
                            p == u ? ((y = -1), (m.y = p + c.h), (C.y = u + d.h)) : p > u ? ((m.y = p), (C.y = u + d.h)) : ((m.y = p + c.h), (C.y = u));
                        break;
                    case OrgChart.orientation.left:
                    case OrgChart.orientation.left_top:
                        v <= x ? ((y = -1), (m.y = v + c.h / 5), (C.y = x + d.h / 5)) : ((y = 1), (m.y = v - c.h / 5), (C.y = x + d.h / 5)),
                            g == f ? ((y = -1), (m.x = g), (C.x = f)) : g > f ? ((m.x = g), (C.x = f + d.w)) : ((m.x = g + c.w), (C.x = f));
                        break;
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        v <= x ? ((y = 1), (m.y = v + c.h / 5), (C.y = x + d.h / 5)) : ((y = -1), (m.y = v - c.h / 5), (C.y = x + d.h / 5)),
                            g == f ? ((y = 1), (m.x = g + c.w), (C.x = f + d.w)) : g > f ? ((m.x = g), (C.x = f + d.w)) : ((m.x = g + c.w), (C.x = f));
                }
                var _ = I(m, C, y),
                    w = h.template;
                w || (w = "orange");
                var k = OrgChart.clinkTemplates[w],
                    S = ((r = m), (a = _), (n = void 0), (o = void 0), (n = ((i = C).x - r.x) / 2 + r.x), (o = (i.y - r.y) / 2 + r.y), { x: (n - a.x) / 2 + a.x, y: (o - a.y) / 2 + a.y });
                h.label && (l += k.label.replace("{x}", S.x).replace("{y}", S.y).replace("{val}", h.label));
                var A = "M" + m.x + "," + m.y + "C" + m.x + "," + m.y + " " + _.x + "," + _.y + " " + C.x + "," + C.y;
                (l +=
                    ("<g " + OrgChart.attr.c_link_from + '="{from}" ' + OrgChart.attr.c_link_to + '="{to}">').replace("{from}", c.id).replace("{to}", d.id) +
                    k.link.replaceAll("{d}", A) +
    ...
    (OrgChart.prototype._slinks = function (t, e) {
        ...
        function n(e, n, o) {
            ...
            var u = { p: e.x + e.w / 2 + p.expandCollapseSize, q: e.y, r: e.x + e.w / 2 + p.expandCollapseSize, s: a.minY + f };
            if (e.sl == n.sl)
                switch (((h = n), g.orientation)) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                        s.push([u.p, u.q]), s.push([u.p, u.q - f / 3]), (p = OrgChart.t(h.templateName, h.min, i)), s.push([h.x + h.w / 2 + p.expandCollapseSize, s[s.length - 1][1]]), s.push([s[s.length - 1][0], h.y]);
                        break;
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                        (u.q = e.y + e.h),
                ...
                switch (g.orientation) {
                    ...
                    case OrgChart.orientation.left:
                    case OrgChart.orientation.left_top:
                        (u.p = e.x), (u.q = e.y + e.h / 2 + p.expandCollapseSize), (u.r = a.minX - f), (u.s = e.y + e.h / 2 + p.expandCollapseSize), s.push([u.p, u.q]), s.push([e.x - f / 3, u.q]);
                        break;
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        (u.p = e.x + e.w), (u.q = e.y + e.h / 2 + p.expandCollapseSize), (u.r = a.maxX + f), (u.s = e.y + e.h / 2 + p.expandCollapseSize), s.push([u.p, u.q]), s.push([e.x + e.w + f / 3, u.q]);
                }
                for (var m = e; null == h;) {
                    var C = !1,
                        O = m.parent,
                        b = O.leftNeighbor,
                        v = O.rightNeighbor;
                    if ((O.id == n.id ? (h = O) : OrgChart._intersects(O, u, t.config) && ((u = OrgChart._addPoint(O, s, t.config, u, c)), (C = !0)), O.id != n.id)) {
                        for (; b;) {
                            if (b.id == n.id) {
                                h = b;
                                break;
                            }
                            OrgChart._intersects(b, u, t.config) && ((u = OrgChart._addPoint(b, s, t.config, u, c)), (C = !0)), (b = b.leftNeighbor);
                        }
                        for (; v;) {
                            if (v.id == n.id) {
                                h = v;
                            ...
                            OrgChart._intersects(v, u, t.config) && ((u = OrgChart._addPoint(v, s, t.config, u, c)), (C = !0)), (v = v.rightNeighbor);
                        }
                    }
                    if (!C) {
                        var x = s[s.length - 1][0],
                            y = 0;
                        if (O.parent)
                            switch (((f = g.levelSeparation), (O.parent.layout != OrgChart.mixed && O.parent.layout != OrgChart.tree) || (f = g.mixedHierarchyNodesSeparation), g.orientation)) {
                                case OrgChart.orientation.top:
                                case OrgChart.orientation.top_left:
            ...
            switch ((p = OrgChart.slinkTemplates[_]).labelPosition) {
                ...
                case "middle":
                    ...
                    (w = s[A]), (k = s[A - 1]), (S = { x: (w[0] + k[0]) / 2, y: (w[1] + k[1]) / 2 });
                    break;
                case "end":
            ...
            o && ((P = n.id), (T = e.id)),
                (r +=
                    ("<g " + OrgChart.attr.s_link_from + '="{from}" ' + OrgChart.attr.s_link_to + '="{to}">').replace("{from}", P).replace("{to}", T) +
        ...
        if (t.config.miniMap && t.manager.action != OrgChart.action.move) {
            (OrgChart.miniMap._settings._scale = Math.min(OrgChart.miniMap.width / (t.response.boundary.maxX - t.response.boundary.minX), OrgChart.miniMap.height / (t.response.boundary.maxY - t.response.boundary.minY))),
                (OrgChart.miniMap._settings._translateX =
                    -t.response.boundary.minX * OrgChart.miniMap._settings._scale + (OrgChart.miniMap.width - (t.response.boundary.maxX - t.response.boundary.minX) * OrgChart.miniMap._settings._scale) / 2),
                (OrgChart.miniMap._settings._translateY =
                    -t.response.boundary.minY * OrgChart.miniMap._settings._scale + (OrgChart.miniMap.height - (t.response.boundary.maxY - t.response.boundary.minY) * OrgChart.miniMap._settings._scale) / 2);
            var r = t.getViewBox();
        ...
        for (var d = {}, g = 0; g < t.length; g++)
            for (var p = t[g], f = 0; f < r.length; f++) {
                ...
                if (!OrgChart.isNEU(p[u])) {
                    var m = p[u];
                    if (null != (e = OrgChart._search.searchAndComputeScore(h, m, u, n))) {
                        var C = p.id;
                        if (d[C]) {
                        ...
                        } else (d[C] = e.__score), OrgChart._search.addNodeToResult(l, i, p, e, u, a);
                    }
                }
            }
        return (
    ...
    (OrgChart._search.searchAndComputeScore = function (t, e, r, i) {
        ...
        0 != s && (m = 100 - s / o);
        var C = 0;
        i && i[r] && (C = i[r]), f && (f = (f / 100) * 50), u > 0 && (u = (u / 100) * 10), m > 0 && (m = (m / 100) * 10), h > 0 && (h = (h / 100) * 10), C > 0 && (C = (C / 100) * 20);
        var O = Math.round(1e4 * (f + u + m + h + C));
        n.sort(function (t, e) {
        ...
        if (l) {
            ...
            if (l.writeToUrlParams) {
                ...
                c.has(s.paramScale) ? c.set(s.paramScale, h.scale) : c.append(s.paramScale, h.scale),
                    ...
                    c.has(s.paramRoots) && Array.isArray(h.roots) ? c.set(s.paramRoots, h.roots.join("*")) : Array.isArray(h.roots) && c.append(s.paramRoots, h.roots.join("*")),
                    c.has(s.paramMin) ? c.set(s.paramMin, h.min.join("*")) : c.append(s.paramMin, h.min.join("*")),
                    c.has(s.paramAdjustify) ? c.set(s.paramAdjustify, h.adjustify.x + "*" + h.adjustify.y) : c.append(s.paramAdjustify, h.adjustify.x + "*" + h.adjustify.y),
    ...
    (OrgChart.elements.textbox = function (t, e, r, i) {
        ...
        var n = "";
        return (
            e.btn && (n = `<a href="#" boc-input-btn="" class="boc-link boc-link-boc-button">${e.btn}</a>`),
            {
                html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${a.disabledAttribute} ${a.vlidators}>\n                        <label for="${a.id
                    }">${OrgChart._escapeGreaterLessSign(a.label)}</label>\n                        <input ${a.readOnlyAttribute} data-binding="${OrgChart._escapeDoubleQuotes(a.binding)}" maxlength="256" id="${a.id}" name="${a.id
    ...
    (OrgChart.elements.date = function (t, e, r, i) {
        ...
        return a.doNotRender
            ...
            : {
                html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${a.disabledAttribute} ${a.vlidators}>\n                        <label for="${a.id
                    }" class="hasval">${OrgChart._escapeGreaterLessSign(a.label)}</label>\n                        <input data-binding="${OrgChart._escapeDoubleQuotes(a.binding)}" ${a.readOnlyAttribute} maxlength="256" id="${a.id}" name="${a.id
    ...
    (OrgChart.filterUI.prototype.update = function () {
        if (this.instance.config.filterBy) {
            ...
            else if (Array.isArray(this.instance.config.filterBy)) for (e = 0; e < this.instance.config.filterBy.length; e++) t[this.instance.config.filterBy[e]] = {};
            ...
            if (null != this.filterBy) for (var l in t) if (this.filterBy[l]) for (var s in t[l]) this.filterBy[l][s] && (t[l][s] = this.filterBy[l][s]);
            this.filterBy = t;
            var h = this,
                                    ...
                                    if (e) {
                                        ...
                                        if (t.target.hasAttribute("data-all")) {
                                            for (var i = t.target.parentNode.parentNode.querySelectorAll("input"), a = 0; a < i.length; a++)
                                                if (i[a] != t.target) for (var n in ((i[a].checked = t.target.checked), h.filterBy[r])) h.filterBy[r][n].checked = t.target.checked;
        ...
        for (var i = {}, a = 0; a < t.length; a++) {
            if ((s = t[a]).stContainerNodes)
                for (var n = s.stContainerNodes.length - 1; n >= 0; n--) {
                    ...
                    (o.w = l.maxX - l.minX + o.padding[3] + o.padding[1]), (o.h = l.maxY - l.minY + o.padding[0] + o.padding[2]), o._m && ((o._m.w = o.w), (o._m.h = o.h)), (i[o.id] = l);
                }
        }
    ...
    (OrgChart.local._walk = function (t, e) {
        ...
        for (o = 0; o < t.length; o++) {
            ...
            var s,
                h = 0;
            switch ((s > 0 && (h = a[s - 1] + l.siblingSeparation), OrgChart.local._secondWalk(t[o], 0, 0, h, i, r, l), (a[s] = r.maxY - r.minY), l.orientation)) {
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
    ...
    (OrgChart.local._firstWalk = function (t, e, r, i, a) {
        if (!t.isPartner) {
            ...
            if (
                ...
                if (
                    (s.isAssistant && h.isAssistant && t.children.length > 1 && t.children[1].isSplit && (c = t.children[1]._prelim + OrgChart.local._mid(t.children[1], a)),
                        s.layout && h.layout && "mirror" != s.templateName && "mirror" != h.templateName && t.children.length > 1 && t.children[1].isSplit && (c = t.children[1]._prelim + OrgChart.local._mid(t.children[1], a)),
                    ...
                    (t._prelim = n._prelim + OrgChart.local._nodeWithPartnersSize(n, a) + d), (t._modifier = t._prelim - c), OrgChart.local._apportion(t, e, r, a);
    ...
    (OrgChart.local._secondWalk = function (t, e, r, i, a, n, o) {
        if (e <= OrgChart.MAX_DEPTH && !t.isPartner) {
            ...
            if (((c = a[e]), (l = OrgChart.local._getNodeHeight(t, o)), t.layout)) {
                ...
                t.leftNeighbor &&
                    ...
                    ((d = OrgChart.local._getNodeHeight(t.leftNeighbor, o)),
                        t.leftNeighbor.leftNeighbor && t.leftNeighbor.leftNeighbor.layout && t.leftNeighbor.leftNeighbor.pid == t.pid && (p = OrgChart.local._getNodeHeight(t.leftNeighbor.leftNeighbor, o))),
                    t.rightNeighbor &&
                    t.rightNeighbor.layout &&
                    t.rightNeighbor.pid == t.pid &&
                    ((g = OrgChart.local._getNodeHeight(t.rightNeighbor, o)),
                        t.rightNeighbor.rightNeighbor && t.rightNeighbor.rightNeighbor.layout && t.rightNeighbor.rightNeighbor.pid == t.pid && (f = OrgChart.local._getNodeHeight(t.rightNeighbor.rightNeighbor, o))),
                    (c = Math.max(l, d, g, p, f));
            }
            switch (((t.x = s), (t.y = h), t.hasPartners && OrgChart.local.nodeHasPartnersPosition(t, o, c), (t.isSplit || t.isAssistant || 2 == t.layout) && (t.y = h + c / 2 - l / 2), o.orientation)) {
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
            ...
            if ((OrgChart._setMinMaxXY(t, n), 0 != t.children)) {
                var m = o.levelSeparation;
                t.layout && (m = o.mixedHierarchyNodesSeparation);
                var C = 0;
                if ((OrgChart.local._secondWalk(t.children[C], e + 1, r + t._modifier, i + c + m, a, n, o), t.children[C].isPartner)) {
                    for (; t.children.length - 1 > C && t.children[C].isPartner;) OrgChart._setMinMaxXY(t.children[C], n), C++;
                    OrgChart._setMinMaxXY(t.children[C], n), OrgChart.local._secondWalk(t.children[C], e + 1, r + t._modifier, i + c + m, a, n, o);
                }
            }
    ...
    (OrgChart.local._apportion = function (t, e, r, i) {
        if (!t.isPartner)
            for (var a = OrgChart.local._fChild(t), n = a.leftNeighbor, o = 1, l = OrgChart.MAX_DEPTH - e; null != a && null != n && o <= l;) {
                for (var s = 0, h = 0, c = a, d = n, g = 0; g < o; g++) (c = c.parent), (d = d.parent), (s += c._modifier), (h += d._modifier);
                ...
                if (f > 0) {
                    for (var u = t, m = 0; null != u && u != d; u = OrgChart.local._getLeftSibling(u)) m++;
                    if (null != u)
                        for (var C = t, O = f / m; C != d; C = OrgChart.local._getLeftSibling(C)) {
                            (C._prelim += f), (C._modifier += f), (f -= O);
                        }
                }
                o++, null != (a = OrgChart.local._hasChildren(a) ? OrgChart.local._fChild(a) : OrgChart.local._getLeftmost(t, 0, o)) && (n = a.leftNeighbor);
            }
    }),
    ...
    (OrgChart.local._setNeighbors = function (t, e, r) {
        (r[e] && r[e].id === t.id) || ((t.leftNeighbor = r[e]), null != t.leftNeighbor && (t.leftNeighbor.rightNeighbor = t), t.isPartner || (r[e] = t));
    }),
        ...
        switch (e.orientation) {
            ...
            case OrgChart.orientation.left_top:
                switch (t.hasPartners) {
                    ...
                    case 4:
                        if (e.orientation <= 3) {
                            (r = OrgChart.local._rightMidPoint(OrgChart.local._fChild(t), e)), (i = OrgChart.local._leftMidPoint(t.children[t.children.length - 1], e));
    ...
    (OrgChart.local.nodeHasPartnersPosition = function (t, e, r) {
        switch (e.orientation) {
            ...
            case OrgChart.orientation.bottom_left:
                ...
                (t.x += i), t.h < r && (e.orientation == OrgChart.orientation.bottom || e.orientation == OrgChart.orientation.bottom_left ? (t.y -= (r - t.h) / 2) : (t.y += (r - t.h) / 2));
                break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
                ...
                (t.x += a), t.w < r && (e.orientation == OrgChart.orientation.right || e.orientation == OrgChart.orientation.right_top ? (t.y -= (r - t.w) / 2) : (t.y += (r - t.w) / 2));
        }
    }),
    (OrgChart.local.nodeIsPartnerPosition = function (t, e, r, i) {
        ...
        switch (e.orientation) {
            ...
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
                (a = OrgChart.local._getPartnerLeftPanelHeight(t.parent, e)), (n = OrgChart.local._getPartnerRightPanelHeight(t.parent, e));
                for (var f = 0; f < t.parent.children.length; f++) {
                    1 == (u = t.parent.children[f]).isPartner
                        ? ((o = t.parent.x + t.parent.w + t.parent.partnerSeparation),
                            g ? ((l = t.parent.y - (r[i - 1] - t.parent.h) / 2 + (r[i - 1] - n) / 2), (d = u.h), (g = !1)) : ((l += d + e.partnerNodeSeparation), (d = u.h)),
                            (u.x = o),
                            (u.y = l))
                        : 2 == u.isPartner &&
                        ((s = t.parent.x - u.w - t.parent.partnerSeparation),
                            p ? ((h = t.parent.y - (r[i - 1] - t.parent.h) / 2 + (r[i - 1] - a) / 2), (c = u.h), (p = !1)) : ((h += c + e.partnerNodeSeparation), (c = u.h)),
                            (u.x = s),
                            (u.y = h));
                }
                break;
            ...
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
                (a = OrgChart.local._getPartnerLeftPanelWidth(t.parent, e)), (n = OrgChart.local._getPartnerRightPanelWidth(t.parent, e));
                for (f = 0; f < t.parent.children.length; f++) {
                    var u;
                    (u = t.parent.children[f]) &&
                        (1 == u.isPartner
                            ? ((l = t.parent.y + t.parent.h + t.parent.partnerSeparation),
                                g ? ((o = t.parent.x - (r[i - 1] - t.parent.w) / 2 + (r[i - 1] - n) / 2), (d = u.w), (g = !1)) : ((o += d + e.partnerNodeSeparation), (d = u.w)),
                                (u.x = o),
                                (u.y = l))
                            : 2 == u.isPartner &&
                            ((h = t.parent.y - u.h - t.parent.partnerSeparation),
                                p ? ((s = t.parent.x - (r[i - 1] - t.parent.w) / 2 + (r[i - 1] - a) / 2), (c = u.w), (p = !1)) : ((s += c + e.partnerNodeSeparation), (c = u.w)),
                                (u.x = s),
                                (u.y = h)));
                }
        }
